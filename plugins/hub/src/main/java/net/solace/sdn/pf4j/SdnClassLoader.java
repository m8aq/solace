...
@Slf4j
public class SdnClassLoader extends PluginClassLoader implements ReflectUtil.PrivateLookupableClassLoader {
    ...
    public Class<?> loadClass(String className) throws ClassNotFoundException {
        synchronized (getClassLoadingLock(className)) {
            ...
            if (runelitePluginManager != null) {
                var plugins = runelitePluginManager.getPlugins();
