...
public class ConfigPanel extends FixedWidthPanel {
    ...
    @Inject
    ConfigPanel(SolaceBreakHandlerPlugin solaceBreakHandlerPlugin) {
    ...
    private void rebuild() {
        ...
        for (ConfigItemDescriptor cid : pluginConfig.getItems()) {
            ...
            if (cid.getType() == boolean.class) {
                ...
                checkbox.setBackground(SolaceBreakHandlerPanel.PANEL_BACKGROUND_COLOR);
            ...
            if (cid.getType() == int.class) {
                ...
                InputStyle.style(spinner, SolaceBreakHandlerPanel.PANEL_BACKGROUND_COLOR);
            ...
            if (cid.getType() instanceof Class && ((Class<?>) cid.getType()).isEnum()) {
                ...
                if (name.isEmpty()) {
                    box.setPreferredSize(new Dimension(PANEL_WIDTH - 10, box.getPreferredSize().height));
                }
                InputStyle.style(box, SolaceBreakHandlerPanel.PANEL_BACKGROUND_COLOR);
