...
public class GoToCustomerArea extends ActionNode {
    public GoToCustomerArea(SolaceArceuusLibrary context) {
        super(context);
    }

    @Override
    public int process() {
        var destination = Room.BC.getWorldPoint();
