...
public final class WallObjectSpawned {
    ...
    public WallObjectSpawned(ITile tile, IWallObject wallObject) {
        this.tile = tile;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WallObjectSpawned)) {
            return false;
        }
    ...
    public String toString() {
        return "WallObjectSpawned(tile=" + String.valueOf(this.getTile()) + ", wallObject=" + String.valueOf(this.getWallObject()) + ")";
    }
}
