...
public final class GroundObjectDespawned {
    ...
    public GroundObjectDespawned(ITile tile, IGroundObject groundObject) {
        this.tile = tile;
    ...
    public String toString() {
        return "GroundObjectDespawned(tile=" + String.valueOf(this.getTile()) + ", groundObject=" + String.valueOf(this.getGroundObject()) + ")";
    }
}
