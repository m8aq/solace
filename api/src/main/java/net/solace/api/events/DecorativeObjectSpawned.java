...
public final class DecorativeObjectSpawned {
    private final ITile tile;
    private final IDecorativeObject decorativeObject;

    public DecorativeObjectSpawned(ITile tile, IDecorativeObject decorativeObject) {
        this.tile = tile;
    ...
    public String toString() {
        return "DecorativeObjectSpawned(tile=" + String.valueOf(this.getTile()) + ", decorativeObject=" + String.valueOf(this.getDecorativeObject()) + ")";
    }
}
