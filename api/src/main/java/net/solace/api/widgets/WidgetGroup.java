...
public final class WidgetGroup {
    ...
    public static final int SAILING_GROUP_ID = 937;

    static class Sailing {
        static final int VIEW_COMBAT_OPTIONS = 1;
        static final int BOAT_NAME = 2;
        static final int BOAT_HEALTH_BAR = 3;
        static final int BOAT_TAB_BAR = 4;
        static final int BOAT_PANEL_TITLE = 6;
        static final int BOAT_CREW_PANEL = 7;
        static final int BOAT_STAT_PANEL = 15;
        static final int BOAT_FACILITIES_PANEL = 22;
        static final int BOAT_CONTROLS = 25;
        static final int BOAT_CREW_CAPACITY = 37;
        static final int BOAT_CREW_TOGGLES = 38;
    ...
    static class SpellBook {
        ...
        static final int TELE_BOAT_TO_ME = 79;
        static final int TELE_ME_TO_BOAT = 80;
        static final int MONSTER_INSPECT = 195;
        static final int ICE_RUSH = 81;
        static final int ICE_BLITZ = 82;
        static final int ICE_BURST = 83;
        static final int ICE_BARRAGE = 84;
        static final int BLOOD_RUSH = 85;
        static final int BLOOD_BLITZ = 86;
        static final int BLOOD_BURST = 87;
        static final int BLOOD_BARRAGE = 88;
        static final int SMOKE_RUSH = 89;
        static final int SMOKE_BLITZ = 90;
        static final int SMOKE_BURST = 91;
        static final int SMOKE_BARRAGE = 92;
        static final int SHADOW_RUSH = 93;
        static final int SHADOW_BLITZ = 94;
        static final int SHADOW_BURST = 95;
        static final int SHADOW_BARRAGE = 96;
        static final int PADDEWWA_TELEPORT = 97;
        static final int SENNTISTEN_TELEPORT = 98;
        static final int KHARYRLL_TELEPORT = 99;
        static final int LASSAR_TELEPORT = 100;
        static final int DAREEYAK_TELEPORT = 101;
        static final int CARRALLANGER_TELEPORT = 102;
        static final int ANNAKARL_TELEPORT = 103;
        static final int GHORROCK_TELEPORT = 104;
        static final int EDGEVILLE_HOME_TELEPORT = 105;
        static final int LUNAR_HOME_TELEPORT = 106;
        static final int BAKE_PIE = 107;
        static final int CURE_PLANT = 108;
        static final int MONSTER_EXAMINE = 109;
        static final int NPC_CONTACT = 110;
        static final int CURE_OTHER = 111;
        static final int HUMIDIFY = 112;
        static final int MOONCLAN_TELEPORT = 113;
        static final int TELE_GROUP_MOONCLAN = 114;
        static final int CURE_ME = 115;
        static final int HUNTER_KIT = 116;
        static final int WATERBIRTH_TELEPORT = 117;
        static final int TELE_GROUP_WATERBIRTH = 118;
        static final int CURE_GROUP = 119;
        static final int STAT_SPY = 120;
        static final int BARBARIAN_TELEPORT = 121;
        static final int TELE_GROUP_BARBARIAN = 122;
        static final int SUPERGLASS_MAKE = 123;
        static final int TAN_LEATHER = 124;
        static final int KHAZARD_TELEPORT = 125;
        static final int TELE_GROUP_KHAZARD = 126;
        static final int DREAM = 127;
        static final int STRING_JEWELLERY = 128;
        static final int STAT_RESTORE_POT_SHARE = 129;
        static final int MAGIC_IMBUE = 130;
        static final int FERTILE_SOIL = 131;
        static final int BOOST_POTION_SHARE = 132;
        static final int FISHING_GUILD_TELEPORT = 133;
        static final int TELE_GROUP_FISHING_GUILD = 134;
        static final int PLANK_MAKE = 135;
        static final int CATHERBY_TELEPORT = 136;
        static final int TELE_GROUP_CATHERBY = 137;
        static final int RECHARGE_DRAGONSTONE = 138;
        static final int ICE_PLATEAU_TELEPORT = 139;
        static final int TELE_GROUP_ICE_PLATEAU = 140;
        static final int ENERGY_TRANSFER = 141;
        static final int HEAL_OTHER = 142;
        static final int VENGEANCE_OTHER = 143;
        static final int VENGEANCE = 144;
        static final int HEAL_GROUP = 145;
        static final int SPELLBOOK_SWAP = 146;
        static final int GEOMANCY = 147;
        static final int SPIN_FLAX = 148;
        static final int OURANIA_TELEPORT = 149;
        static final int ARCEUUS_HOME_TELEPORT = 150;
        static final int BASIC_REANIMATION = 151;
        static final int ARCEUUS_LIBRARY_TELEPORT = 152;
        static final int ADEPT_REANIMATION = 153;
        static final int EXPERT_REANIMATION = 154;
        static final int MASTER_REANIMATION = 155;
        static final int DRAYNOR_MANOR_TELEPORT = 156;
        static final int MIND_ALTAR_TELEPORT = 158;
        static final int RESPAWN_TELEPORT = 159;
        static final int SALVE_GRAVEYARD_TELEPORT = 160;
        static final int FENKENSTRAINS_CASTLE_TELEPORT = 161;
        static final int WEST_ARDOUGNE_TELEPORT = 162;
        static final int HARMONY_ISLAND_TELEPORT = 163;
        static final int CEMETERY_TELEPORT = 164;
        static final int RESURRECT_CROPS = 165;
        static final int BARROWS_TELEPORT = 166;
        static final int APE_ATOLL_TELEPORT = 167;
        static final int BATTLEFRONT_TELEPORT = 168;
        static final int INFERIOR_DEMONBANE = 169;
        static final int SUPERIOR_DEMONBANE = 170;
        static final int DARK_DEMONBANE = 171;
        static final int MARK_OF_DARKNESS = 172;
        static final int GHOSTLY_GRASP = 173;
        static final int SKELETAL_GRASP = 174;
        static final int UNDEAD_GRASP = 175;
        static final int WARD_OF_ARCEUUS = 176;
        static final int LESSER_CORRUPTION = 177;
        static final int GREATER_CORRUPTION = 178;
        static final int DEMONIC_OFFERING = 179;
        static final int SINISTER_OFFERING = 180;
        static final int DEGRIME = 181;
        static final int SHADOW_VEIL = 182;
        static final int VILE_VIGOUR = 183;
        static final int DARK_LURE = 184;
        static final int DEATH_CHARGE = 185;
        static final int RESURRECT_LESSER_GHOST = 186;
        static final int RESURRECT_LESSER_SKELETON = 187;
        static final int RESURRECT_LESSER_ZOMBIE = 188;
        static final int RESURRECT_SUPERIOR_GHOST = 189;
        static final int RESURRECT_SUPERIOR_SKELETON = 190;
        static final int RESURRECT_SUPERIOR_ZOMBIE = 191;
        static final int RESURRECT_GREATER_GHOST = 192;
        static final int RESURRECT_GREATER_SKELETON = 193;
        static final int RESURRECT_GREATER_ZOMBIE = 194;
    ...
    static class Pvp {
        ...
        static final int WILDERNESS_LEVEL = 50;
    ...
    static class ChambersOfXericStorageUnitPrivate {
        ...
        ChambersOfXericStorageUnitPrivate() {
        }
    }
    ...
    static class Prayer {
        ...
        static final int RP_UMBRAS_VOW = 27;
    ...
    static class Minimap {
        ...
        static final int QUICK_PRAYER_ORB = 19;
        static final int PRAYER_ORB_TEXT = 20;
        static final int RUN_ORB = 25;
        static final int TOGGLE_RUN_ORB = 27;
    ...
    static class DepositBox {
        static final int INVENTORY_ITEM_CONTAINER = 23;
        static final int ROOT = 1;
        static final int EXIT_CHILD = 11;
        static final int DEPOSIT_INVENTORY = 29;
        static final int DEPOSIT_EQUIPMENT = 30;
        static final int DEPOSIT_LOOT_BAG = 31;
        static final int DEPOSIT_INVENTORY_QUANTITY_ONE = 34;
        static final int DEPOSIT_INVENTORY_QUANTITY_FIVE = 35;
        static final int DEPOSIT_INVENTORY_QUANTITY_TEN = 36;
        static final int DEPOSIT_INVENTORY_QUANTITY_X = 37;
        static final int DEPOSIT_INVENTORY_QUANTITY_ALL = 38;
